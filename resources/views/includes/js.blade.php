    ...
    <script src=" {{ url('assets/js/animated-heading.js') }} "></script>
    <script src=" {{ url('assets/js/imagesloaded.pkgd.min.js') }} "></script>
    <script src=" {{ url('assets/js/theia-sticky-sidebar.min.js') }} "></script>
    <script src=" {{ url('assets/js/jquery.marquee.min.js') }} "></script>
    <script src=" {{ url('assets/js/isotope.pkgd.min.js') }} "></script>
    <script src=" {{ url('assets/js/jquery.magnific-popup.min.js') }} "></script>
    <script src=" {{ url('assets/js/touchspin.js') }} "></script>
    ...
    <script src=" {{ url('assets/js/scrollspy.js') }} "></script>
    <script src=" {{ url('assets/js/rbtools.min.js') }} "></script>

    ...
    <div class="sidebar-wrapper active">
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-title">General Settings</li>

                <li class="sidebar-item {{ request()->routeIs('profile*', 'websites*') ? 'active' : '' }} has-sub">
                    <a href="#" class='sidebar-link'>
                        <i class="bi bi-gear-fill"></i>
                        <span>Settings</span>
                    </a>
                    <ul class="submenu {{ request()->routeIs('profile*', 'websites*') ? 'active' : '' }}">
                        <li class="submenu-item {{ request()->routeIs('profile*') ? 'active' : '' }}">
                            <a href="{{ route('profile.edit') }}">Profile</a>
                        </li>
                        <li class="submenu-item ">
                            <a href="form-element-input-group.html">Website</a>
                        </li>
                    </ul>
                </li>

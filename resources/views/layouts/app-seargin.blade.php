...
<head>
    ...
    <title>Seargin - Business Consulting HTML Template</title>
...
<body>
    ...
    <div class="body_wrap">
                ...
                <div class="container mxw_1710">
                    <div class="ul_li_between">
                            ...
                            <nav class="main-menu collapse navbar-collapse">
                                <ul>
                                    <li class="menu-item-has-children active"><a href="index.html"><span>Home</span></a>
                                        <ul class="submenu">
                                            <li class="active"><a href="index.html"><span>Financial
                                                        Consultant</span></a></li>
                                            <li><a href="home-business.html"><span>Business Consultant</span></a></li>
                                            <li><a href="home-digital-marketing.html"><span>Digital Marketing</span></a>
                                            </li>
                        ...
                        <div class="xb-header__btn d-none d-lg-block">
                            <a class="xb-btn" href="#!">LOGIN / SIGNUP</a>
                        </div>
        ...
        <main>
            ...
            <!-- hero start -->
            <section class="hero hero-default ul_li bg_img" data-bg-color="#E7E9EE"
                    ...
                    <div class="row align-items-center">
                        <div class="hero-content">
                            <div class="sec-title mb-40">
                                ...
                                <h2 class="title title-big" data-aos="fade-up" data-aos-duration="600"
                                    data-aos-delay="200">Guiding Financial <br> Success</h2>
                            </div>
                            ...
                            <div class="xb-item--btn btns" data-aos="fade-up" data-aos-duration="600"
                                data-aos-delay="600">
            ...
            <section class="feature feature-pb pt-150 pb-150" data-background="assets/img/bg/feat_bg.jpg">
                <div class="container px-60">
                    <div class="row align-items-start mt-none-30">
                        ...
                        <div class="col-xl-5 offset-xl-3 col-lg-6 offset-lg-2 mt-30" data-aos="fade-left"
            ...
            <section class="team bg_img pt-140 pb-140" data-background="assets/img/bg/team_bg.jpg">
                <div class="container px-60">
                    <div class="sec-title sec-title--white text-center mb-70" data-aos="fade-up"
                                        ...
                                        <div class="xb-item--inner">
                                            ...
                                            <ul class="xb-item--social ul_li_center">
                                                <li><a class="twitter" href="#!"><img
                                                            src="assets/img/icon/twitter-x.svg" alt=""></a></li>
            ...
            <!-- blog start -->
            <section class="blog pt-150 pb-150">
                <div class="container">
                    <div class="row g-12 mt-none-12">
                        <div class="col-lg-6 mt-12">
                            <div class="xb-blog h-100">
                                <div class="xb-item--inner ul_li h-100" data-bg-color="#F3F4F5">
                                    <div class="sec-title">
                                        <span class="subtitle ul_li"><img src="assets/img/icon/hr_icon.png" alt="">Check
                                            our Insight</span>
                                        <h2 class="title mb-40">Explore Financial Insights</h2>
                                        <p>Stay Informed and Empower Your Financial Future with <br> Our Popular Blog
                                            and Articles</p>
                                    </div>
                                    <div class="xb-item--shape">
                                        <img src="assets/img/shape/blog_shape.png" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 mt-12">
                            <div class="xb-blog">
                                <div class="xb-item--inner">
                                    <span class="xb-item--cat">Finance Planing</span>
                                    <h2 class="xb-item--title border-effect"><a href="blog-single.html">Financial
                                            Mistakes to Avoid in Your 30s, 40s, and Beyond</a></h2>
                                    <p class="xb-item--content">Stay Informed and Empower Your Financial Future with Our
                                        Popular Blog and Articles and most popular insight ever.</p>
                                    <div class="xb-item--meta ul_li_between">
                                        <div class="xb-item--author ul_li">
                                            <div class="xb-item--avatar">
                                                <img src="assets/img/avatar/blog_avatar1.png" alt="">
                                            </div>
                                            <span class="xb-item--name">Malandiya Dime</span>
                                        </div>
                                        <span class="xb-item--like">260 <i class="fas fa-heart"></i></span>
                                        <span class="xb-item--date">12.January.2021<i class="far fa-clock"></i></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 mt-12">
                            <div class="xb-blog">
                                <div class="xb-item--inner">
                                    <span class="xb-item--cat color-2">Business' Managements</span>
                                    <h2 class="xb-item--title border-effect"><a href="blog-single.html">The Art of
                                            Budgeting Building Wealth One Dollar at a Time</a></h2>
                                    <p class="xb-item--content">Stay Informed and Empower Your Financial Future with Our
                                        Popular Blog and Articles and most popular insight ever.</p>
                                    <div class="xb-item--meta ul_li_between">
                                        <div class="xb-item--author ul_li">
                                            <div class="xb-item--avatar">
                                                <img src="assets/img/avatar/blog_avatar2.png" alt="">
                                            </div>
                                            <span class="xb-item--name">OM Shan Omaly</span>
                                        </div>
                                        <span class="xb-item--like">450 <i class="fas fa-heart"></i></span>
                                        <span class="xb-item--date">12.January.2021<i class="far fa-clock"></i></span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6 mt-12">
                            <div class="xb-blog">
                                <div class="xb-item--inner">
                                    <span class="xb-item--cat color-3">Insurance 2023</span>
                                    <h2 class="xb-item--title border-effect"><a href="blog-single.html">Planning for
                                            College Navigating the Costs and Options</a></h2>
                                    <p class="xb-item--content">Stay Informed and Empower Your Financial Future with Our
                                        Popular Blog and Articles and most popular insight ever.</p>
                                    <div class="xb-item--meta ul_li_between">
                                        <div class="xb-item--author ul_li">
                                            <div class="xb-item--avatar">
                                                <img src="assets/img/avatar/blog_avatar3.png" alt="">
                                            </div>
                                            <span class="xb-item--name">Corner Megrego</span>
                                        </div>
                                        <span class="xb-item--like">180 <i class="fas fa-heart"></i></span>
                                        <span class="xb-item--date">12.January.2021<i class="far fa-clock"></i></span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="xb-blog__btn mt-60 text-center">
                        <a class="xb-btn" href="blog.html">See More INsight</a>
                    </div>
                </div>
            </section>
            <!-- blog end -->
        ...
        <!-- footer start -->
        <footer class="xb-footer sticky z-1 pos-rel footer-style-one pt-110 pb-110" data-bg-color="#E7E9EE">
            <div class="container">
                <div class="footer-cta ul_li_between">
                    <div class="footer-cta__inner ul_li mt-30">
                        <div class="xb-icon-img style-2 ul_li mr-35">
                            <div class="avatar">
                                <img src="assets/img/avatar/cta_avatar2.png" alt="">
                            </div>
                            <div class="icon">
                        ...
                        <div class="footer-cta__holder">
                            <span>Drop here a note</span>
                            <h3>seargin@gmail.com</h3>
                        </div>
                    </div>
                    <div class="footer-cta__inner ul_li mt-30">
                        <div class="footer-cta__holder text-end">
                            <span>Call us Directly</span>
                            <h3>+1-202-555-0160</h3>
                        </div>
                        <div class="xb-icon-img ul_li ml-35">
                            <div class="icon">
                                <i class="fas fa-phone"></i>
                            </div>
                            <div class="avatar">
                                <img src="assets/img/avatar/cta_avatar3.png" alt="">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mt-none-40">
                        <div class="col-lg-3 footer-col mt-40">
                            <div class="footer-widget">
                                <h3 class="widget-title">Subscribe Newsletter for Update </h3>
                                <p>Sign up to seargin weekly newsletter <br> to get the latest updates.</p>
                                <form action="#" class="footer-newsletter mt-45">
                        ...
                        <div class="col-lg-3 footer-col mt-40">
                            <div class="footer-widget">
                                <h3 class="widget-title">About Seargin</h3>
                                <ul class="widget-links list-unstyled">
            ...
            <div class="footer-shape">
                <div class="shape shape--1">
                    <img data-parallax='{"y": "-80"}' src="assets/img/shape/ft_shape1.png" alt="">
                </div>
                <div class="shape shape--2">
                    <img data-parallax='{"y": "80"}' src="assets/img/shape/ft_shape2.png" alt="">
                </div>
            </div>
        </footer>
        <!-- footer start -->
